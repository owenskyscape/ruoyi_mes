...
public class MesCrystalInfoController extends BaseController
{
     ...
     * 查询晶棒信息列表
     */
    @RequiresPermissions("mes:info:list")
    @PostMapping("/list")
    @ResponseBody
     ...
     * 导出晶棒信息列表
     */
    @RequiresPermissions("mes:info:export")
     ...
     * 新增保存晶棒信息
     */
    @RequiresPermissions("mes:info:add")
     ...
     * 修改晶棒信息
     */
    @RequiresPermissions("mes:info:edit")
    @GetMapping("/edit/{id}")
     ...
     * 删除晶棒信息
     */
    @RequiresPermissions("mes:info:remove")
